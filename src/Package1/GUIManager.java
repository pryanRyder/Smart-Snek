...
public class GUIManager extends Application {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see javafx.application.Application#start(javafx.stage.Stage) the class you
	 * run to run the project and it creates a stage and scene that considers the
	 * device it's running from in terms of its size
	 */
